          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="mailto:hi@cyzorastudio.com" className="flex items-center gap-3 p-4 rounded-2xl transition-all hover:brightness-105" style={{ background: 'var(--grayDark)', border: '1px solid var(--border)' }}>
                ...
                <a href="tel:0758335592" className="flex items-center gap-3 p-4 rounded-2xl transition-all hover:brightness-105" style={{ background: 'var(--grayDark)', border: '1px solid var(--border)' }}>
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 bg-brand-accent-faint text-[rgb(var(--accent-rgb))]">
                    <Phone size={18} />
                  </div>
                  <div>
              ...
              <div style={{ borderTop: '1px solid var(--border)', paddingTop: '1.5rem' }}>
                {submitted ? (
                  ...
                  <form onSubmit={handleModalSubmit} className="space-y-3">
                    ...
                    <input type="text" required placeholder="Your Name / Company" value={name} onChange={(e) => setName(e.target.value)} className="w-full rounded-xl px-4 py-3 text-xs focus:outline-none" style={{ background: 'var(--grayDark)', color: 'var(--textLight)', border: '1px solid var(--border)' }} />
                    <textarea required placeholder="How can we help you today?" rows={3} value={msg} onChange={(e) => setMsg(e.target.value)} className="w-full rounded-xl px-4 py-3 text-xs focus:outline-none resize-none" style={{ background: 'var(--grayDark)', color: 'var(--textLight)', border: '1px solid var(--border)' }} />
                    <button type="submit" className="w-full text-white font-extrabold text-xs py-3 rounded-xl flex items-center justify-center gap-2 hover:brightness-110 transition-all" style={{ background: 'rgb(var(--accent-rgb))' }}>
                      <Send size={14} />
